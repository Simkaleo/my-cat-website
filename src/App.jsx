...
function App() {
  ...
  const fetchUrl = selectedBreed === "" ? API_URL : API_URL + queryString;

  console.log(fetchUrl);

  return (
    <>
      {/* make an input that selects a specific cat breed */}
      <SelectBreed
      ...
      // if then, fetch the breeds list and update the input to use the list of available breeds */}
